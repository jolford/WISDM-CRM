...
-- Phase 2: Since we can't add RLS to views directly, we need to recreate them with security
-- Drop and recreate contacts_export_view with proper filtering
...
-- Similarly recreate deal_collections_summary with proper filtering
