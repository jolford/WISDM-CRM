...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE policyname = 'Users can view invoices for their deals' 
      AND schemaname = 'public' AND tablename = 'deal_invoices'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE policyname = 'Users can insert invoices for their deals' 
      AND schemaname = 'public' AND tablename = 'deal_invoices'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE policyname = 'Users can update invoices for their deals' 
      AND schemaname = 'public' AND tablename = 'deal_invoices'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE policyname = 'Users can delete invoices for their deals' 
      AND schemaname = 'public' AND tablename = 'deal_invoices'
  ) THEN
