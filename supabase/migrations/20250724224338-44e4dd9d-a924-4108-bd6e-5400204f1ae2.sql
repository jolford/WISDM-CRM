...
WITH CHECK (
  auth.uid() = id AND
  -- Prevent users from updating role or is_active fields
...
ALTER VIEW public.contacts_import_view ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can view their own contacts import data"
ON public.contacts_import_view
FOR SELECT
